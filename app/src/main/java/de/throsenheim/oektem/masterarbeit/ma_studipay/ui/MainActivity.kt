package de.throsenheim.oektem.masterarbeit.ma_studipay.ui
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bankRepositoryImpl = BankRepositoryImpl(bankDao = database.bankDao())
    ...
    private fun navigateBasedOnLoginStatus() {
        ...
        window.decorView.post {
            ...
            if (isLoggedIn) {
                Log.d(
                    "MainActivity",
                    "User is logged in: ${sharedPref.getString("username", "matriculationNumber")}"
                )
